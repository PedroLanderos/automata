...
class Automat:
    ...
    def ProcessInput(self, input, animate=False):
        for symbol in input:
            ...
            # Registrar la descripcion instantanea (ID)
    ...
    def DisplayState(self, symbol):
        ...
        print("\033[H\033[J", end="")  # Limpia la pantalla para la animacion
        ...
        time.sleep(1)  # Pausa para crear efecto de animacion
